...
import com.haxifang.ttad.views.FeedView;

import java.util.Map;

public class Feed extends ViewGroupManager<FeedView> {

    public static final String REACT_CLASS = "TTAdFeed";
    private ReactContext mContext;

    public Feed(ReactApplicationContext context) {
        mContext = context;
    }
